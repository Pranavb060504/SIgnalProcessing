...
\title{5 V Charger Using a Low Pass Analog Filter}
\author{Pranav B}
\maketitle
\tableofcontents
...
The schematic diagram of the entire circuit is shown below.
\begin{figure}[!htb]
...
The transformer used is a step down transformer which gives 12 V ,50 Hz output.

\subsection{Rectifier}
The full-wave rectifier is realized using four diodes.output is a DC 12 V, 50 Hz rectified sinusoid.
...
a constant DC supply of 5 V. Thus, we obtain an almost
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{p3}
    \caption{Output AC waveform at transformer stage across AB (18 V peak).}
    \label{fig:p3}
\end{figure}

\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{p4}
    \caption{Output half-wave rectified waveform across diode across AD (18 V peak).}
    \label{fig:p4}
\end{figure}

\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{p2}
    \caption{Output DC waveform at filter stage across In-Gnd (18 V).}
    \label{fig:p2}
\end{figure}

\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{p1}
    \caption{Output DC waveform at regulator stage across Out-Gnd (5 V).}
    \label{fig:p1}
\end{figure}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item Use of lab equipment such as solder, oscilloscope, breadboard, PCB, etc. to realize a circuit.
\end{enumerate}
\end{document}
