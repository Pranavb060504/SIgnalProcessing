...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/3/xnyn.pdf}
\end{center}
\captionof{figure}{}
\label{fig:xnyn}	
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/4/dtft}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/5/hn}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/5/hndef}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/5/ynconv}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/6/yndft}
...
\item Show that 
    ...
    \end{align}
		...
		x(N-1)
		\end{pmatrix}\\
		X(k)=\sum_{i=0}^{N-1}x(i)e^{\frac{2 \pi j k i}{N}}
		\end{align}
		Therefore $\vec{X}$ can be represented as :
		\begin{align}
		\vec{X}=\vec{F}_N \vec{x}
		\end{align}
		where $\vec{F}_N=\left[e^{\frac{2 \pi jik}{N}}\right]_{(N-1)\times (N-1)} 0\leq i,k \leq N-1$
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/FFT/Time}
...
Run the following code 
\begin{lstlisting}
wget https://github.com/Pranavb060504/SIgnalProcessing/blob/main/7/7_2_1.py
\end{lstlisting}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/7/7_2_1.png}
\caption{$|H(e^{j\omega})|$}
\end{figure}
Run the following code 
\begin{lstlisting}
wget https://github.com/Pranavb060504/SIgnalProcessing/blob/main/7/7_2_2.py
\end{lstlisting}
Use the following command in the terminal to run the code and generate the figure below
\begin{lstlisting}
python3 7_2_2.py
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/7/7_2_2.png}
\caption{h(n)}
\end{figure}
