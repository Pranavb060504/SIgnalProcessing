...
\begin{lstlisting}
https://github.com/Pranavb060504/SIgnalProcessing/blob/main/pingala/pingala1.py
\end{lstlisting}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/1.1}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/1.2}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/1.3}
\caption{}
\end{figure}
 \item 
\begin{align}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/1.4}
\caption{}
\end{figure}
...
Run the below python code 
\begin{lstlisting}
https://github.com/Pranavb060504/SIgnalProcessing/blob/main/pingala/pingala2.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
python3 pingala2.py
...
\begin{figure}[ht!]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/2(2)}
\caption{}
\end{figure}
\item Find $X^{+}(z)$.\\
\solution:
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{/home/pranav/Desktop/Signal processing/pingala/2(5)}
\caption{}
\end{figure}
	\item Find $Y^{+}(z)$.
	\\
...
\begin{lstlisting}
https://github.com/Pranavb060504/SIgnalProcessing/blob/main/pingala/Xk.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
python3 Xk.py
