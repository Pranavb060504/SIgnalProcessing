...
\\
\solution $|H(e^{i \omega})|$ has a fundamental period of $2 \pi$. The following code plots Fig. \ref{fig:dtft}.
\begin{lstlisting}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{dtft}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{hn}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{hndef}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{ynconv}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{yndft}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{fft_ifft}
\caption{IFFT}
\label{fig:fft_ifft}
\end{figure}
