...
\text{This \quad is \quad a\quad infinite \quad geometric\quad  series\quad  with\quad  common \quad ratio<1}\\
=\frac{1}{1-a z^{-1}} (\because \left|\frac{a}{z}\right|<1)
\end{align}
\item 
Let
\begin{equation}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./home/pranav/Desktop/Signal processing/6/ynconv}
